...
<H4>Step 1:</H4> Initially, stack and visited arrays are empty.
...
<H4>Step 2:</H4> Visit 0 and put its adjacent nodes which are not visited yet into the stack.
...
<H4>Step 3:</H4> Now, Node 1 at the top of the stack, so visit node 1 and pop it from the stack and put all of its adjacent nodes which are not visited in the stack.
...
<H4>Step 4:</H4> Now, Node 2 at the top of the stack, so visit node 2 and pop it from the stack and put all of its adjacent nodes which are not visited (i.e, 3, 4) in the stack.
...
<H4>Step 5:</H4> Now, Node 4 at the top of the stack, so visit node 4 and pop it from the stack and put all of its adjacent nodes which are not visited in the stack.
...
<H4>Step 6:</H4> Now, Node 3 at the top of the stack, so visit node 3 and pop it from the stack and put all of its adjacent nodes which are not visited in the stack.
